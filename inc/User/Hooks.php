...
class Hooks {
    ...
    public function add_user_type_field( $user ): void {
        ...
        <table class="form-table">
            <tr>
                <th><label for="user_type"><?php esc_html_e( 'User type', 'ams' ); ?></label></th>
                <td>
                    <select name="user_type" id="user_type">
                        <option value=""><?php esc_html_e( '-- Select user type --', 'ams' ); ?></option>
                        <option value="company" <?php selected( $user_type, 'company' ); ?>><?php esc_html_e( 'Company', 'ams' ); ?></option>
                        <option value="candidate" <?php selected( $user_type, 'candidate' ); ?>><?php esc_html_e( 'Candidate', 'ams' ); ?></option>
                    </select>
